...
Route::get('/articles/search', [ArticleController::class, 'articleSearch'])->name('articles.search')->middleware('throttle:ricerca_articoli', 'suspicious_ips');
...
// Admin routes
Route::middleware(['admin','admin.local','suspicious_ips'])->group(function(){
